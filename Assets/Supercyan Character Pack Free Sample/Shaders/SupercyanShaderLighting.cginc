...
inline half4 LightingSupercyanShadingForward(SurfaceOutput s, half3 viewDir, UnityGI gi)
{
    ...
    diffuse = pow(smoothstep(LightingSupercyanShadingSmoothMin, LightingSupercyanShadingSmoothMax, diffuse),
                  LightingSupercyanShadingSmoothPow);
    rim = (pow(smoothstep(LightingSupercyanShadingSmoothMin, LightingSupercyanShadingSmoothMax, rim),
               LightingSupercyanShadingSmoothPow)) * LightingSupercyanShadingRimStrength;
